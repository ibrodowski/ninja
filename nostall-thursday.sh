...
main() {
  ...
  cd -
  sudo -H -u $SUDO_USER bash -c 'UserName=$(whoami) || /Users/$UserName/work/Webology/Website/Reflektion/bin/virtualenv --system-site-packages /Users/$UserName/work/Webology/Website/Reflektion'
