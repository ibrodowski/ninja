...
#
# Requirements    : To make use of this script, the following conditions must be met, due to a dependencies check that is performed:
#                 : • Script must be executed as sudo
