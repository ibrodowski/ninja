...
# Install dependencies using pip
  ...
  sudo -u $SUDO_USER brew install freetype
  sudo -u $SUDO_USER brew install thrift
  sudo -u $SUDO_USER brew install homebrew/versions/mongodb24
  sudo -u $SUDO_USER brew install homebrew/versions/redis26
  ...
  mysql -u root -h localhost < ~/data/Backup/mysql_dump.sql
