...
# Latest Update   : Tuesday, September 13, 2016
# 
...
scripts=/Library/RFK/Software/bin/scpt
  ...
  xcodeapp="/Applications/Xcode.app"
    ...
    if [ -e "$xcodeapp" ]; then
      ...
      /usr/sbin/lpadmin -p "HP_LaserJet_200_Color_MFP_276nw" -E -v "lpd://x.x.x.x" -P /Library/Printers/PPDs/Contents/Resources/HP\ LaserJet\ 200\ color\ MFP\ M276.gz -D "HP LaserJet 200 Color MFP M276nw" -L "San Mateo HQ" -o printer-is-shared=false

      # "Install HP LaserJet 500 Color M551"
      /usr/sbin/lpadmin -p "HP_LaserJet_500_Color_M551" -E -v "lpd://x.x.x.x" -P /Library/Printers/PPDs/Contents/Resources/HP\ LaserJet\ 500\ color\ M551.gz -D "HP LaserJet 500 Color M551" -L "San Mateo HQ" -o printer-is-shared=false

      # "Configure default printer"
      sudo -H -u $LoggedInUser /usr/bin/lpoptions -d HP_LaserJet_200_Color_MFP_276nw
    ...
    #
    # This section is intended for the standard image; i.e., non-developer deployment, with Microsoft Office 2016 x64 Edition
    #
    else
      ...
      /usr/sbin/installer -pkg "/Library/RFK/Software/Microsoft/Microsoft_Office_2016_15.25.0_160817_Installer.pkg" -target $3

      # Recoup drive space by deleting /Library/RFK/Software/Microsoft/Microsoft_Office_2016_15.24.0_160709_Installer.pkg
      /usr/bin/srm -s "/Library/RFK/Software/Microsoft/Microsoft_Office_2016_15.25.0_160817_Installer.pkg"

      # "Installing Microsoft Delta Update for Excel 15.25.0 to 15.25.1..."
      /usr/sbin/installer -pkg "/Library/RFK/Software/Excel_15.25.0_160817_to_15.25.1_160826_Delta.pkg" -target $3
